namespace FeatureFlipper.Tests
{
    ...
    public class FeatureNameProviderFixture
    {
        [Theory]
        [InlineData(typeof(FeatureWithoutAttribute), "FeatureFlipper.Tests.FeatureNameProviderFixture+FeatureWithoutAttribute")]
